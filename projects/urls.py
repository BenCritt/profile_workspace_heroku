...
"""
# I'm attempting to deal with Cloudflare's limit on redirects by implementing them here. Work-in-progress.
...
# Define redirects for URI paths.
redirects = {
...
# Add RedirectView patterns dynamically BEFORE direct paths
urlpatterns = (
    [
