water_bodies = [
    ...
    # (Area ≈ 12.0) — two entries here; tie‐broken by original order
    {
    ...
    # (Area ≈ 35.0) — three entries; original order used as tie–breaker
    {
    ...
    # (Area ≈ 245.0)
    {
        ...
        "latitude_range": (
            -60.0,
            0.0,
        ),  # Note: original defined as (-60, -53) for Scotia Sea and (-60, -25) for Scotia Arc;
    ...
    # (Area ≈ 418.0)
    {
        ...
        "longitude_range": (
            162.0,
            200.0,
        ),  # normalized to avoid antimeridian issues
    },
    # (Area ≈ 480.0)
    {
        "name": "Barents Sea",
